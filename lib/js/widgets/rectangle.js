...
function Rectangle(params) {
  ...
  // Create an HTML container for our SVG element
  // DEV: We use border box sizing for the SVG container
  //   but all widths/heights will be in reference to the SVG element itself
  ...
  // Create our SVG element with offsets for stroke width
  ...
  // Insert our SVG element into its container and save it for later
  svgEl.appendChild(rectEl);
  this.content = svgEl;

  // If there is a style, then style our HTML container
  if (params.style) {
