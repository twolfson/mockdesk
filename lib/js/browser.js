...
window.Mockdesk = {
  init: function () {
    ...
    // Retrieve current LiveReload setting
    var liveReloadEnabled = ipcRenderer.sendSync('get:livereload');
    console.log(liveReloadEnabled);
  ...
  toggleLiveReload: function () {
    ...
    logger.info('LiveReload toggled. Enabled:', liveReloadEnabled);
  }
};
