    ...
    return Object.keys(elementMap).map(function createElement (elementName) {
      ...
      function createNewEl() {
        ...
        draggie.pointerDown = function (event, pointer) {
          ...
          var topOffset = boundingRect.top + document.body.scrollTop;
          var leftOffset = boundingRect.left + document.body.scrollLeft;
        ...
        draggie.on('dragEnd', function handleDragEnd (evt, pointer) {
          ...
          // If we are in the workspace
            ...
            createNewEl();
          // Otherwise, return the element to its original position
