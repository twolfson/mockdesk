...
Application.prototype = {
  ...
  //   We need to tolerate bad drops (e.g. dropping back on widget palette)
  ...
  // DEV: We need a separate handler since `draggabillie` can prevent propagation of a static click
