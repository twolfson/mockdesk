...
function Application(container, config) {
  ...
  var elementPaletteEl = D.DIV({
    ...
    return Object.keys(elementMap).map(function createElement (elementName) {
      ...
      //   this.element.style.left = this.dragPoint.x + 'px';
      //   this.element.style.top = this.dragPoint.y + 'px';
      // };
      draggie.on('dragStart', function handleDragStart (evt, pointer) {
        ...
        // https://github.com/desandro/draggabilly/blob/082a68aef38f13e2e6c9098aa6ccc0b429cc9e8c/draggabilly.js#L125-L137
        // console.log( this.pointerDownPoint);
      ...
      draggie.on('dragMove', function handleDragMove (evt, pointer) {
        console.log('dragMove',
          element.content.style.top, element.content.style.left,
