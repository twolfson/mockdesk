...
function Application(container, config) {
  ...
  elementPaletteEl.setAttribute('id', ELEMENT_PALETTE_ID);
  elementPaletteEl.style.cssText = [
    'float: left;',
    'background: white;',
    'width: 120px;',
    'height: 400px;'
...
Application.prototype = {
  ...
  handleClick: function (evt) {
    ...
    var rect = new Rectangle({
      ...
      height: 100,
      style: {
        left: evt.clientX - workspaceElOffset.left,
        position: 'absolute',
        top: evt.clientY - workspaceElOffset.top
      }
    });
