      ...
      function createNewEl() {
        ...
        draggie.on('dragEnd', function handleDragEnd (evt, pointer) {
          ...
          if (true) {
            ...
            var elementBounds = element.content.getBoundingClientRect();
            ...
            workspaceEl.appendChild(element.content);
            element.setStyle({
              left: elementBounds.left - workspaceBounds.left,
              position: 'absolute',
              top: elementBounds.top - workspaceBounds.top
            });
          ...
          // TODO: Instead of creating an element back in the palette,
          //   let's move the element back to the palette and create a local clone
...
Application.prototype = {
  ...
  // TODO: Repair false positive passing static click
