  ...
  this.el = D.DIV({
    ...
    return Object.keys(widgetMap).map(function createWidget (widgetName) {
      ...
      draggie.on('dragEnd', function handleDragEnd (evt, pointer) {
        ...
        var workspaceBounds = app.workspaceEl.getBoundingClientRect();
        ...
        widget.content.style.left = null;
        widget.content.style.top = null;
...
WidgetPalette.prototype = {
  ...
  bind: function (container) {
    ...
    // Add mouse bindings
    delegate(container, '.' + WIDGET_CLASSNAME, 'click', this.handleWidgetClick.bind(this));
  }
};
