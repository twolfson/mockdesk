...
var D = require('../domo');
var WidgetStore = require('../stores/widgets');
...
function WidgetPalette(app) {
  ...
  this.el = D.DIV({
    ...
    var widgetMap = WidgetStore.getMap();
...
WidgetPalette.prototype = {
  ...
  _handleWidgetClick: function (widgetName) {
    // Add a widget to our workspace
    // TODO: If a widget already exists in that position, then shift it 10 pixels down/right
    var WidgetClass = WidgetStore.get(widgetName);
    var widget = new WidgetClass({
      width: 100,
      height: 100,
      style: {
