...
simulant.fire(rectEl, 'mousedown', {button: 0, clientX: startCoords.x, clientY: startCoords.y});
...
var tween = new TWEEN.Tween(startCoords)
  ...
  .onUpdate(function handleUpdate () {
    simulant.fire(rectEl, 'mousemove', {clientX: this.x, clientY: this.y});
  });

// When our drag completes, release our mouse
tween.onComplete(function handleComplete () {
  simulant.fire(rectEl, 'mouseup', {clientX: this.x, clientY: this.y});
});
