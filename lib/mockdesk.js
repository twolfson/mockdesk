...
var mockdesk = {
  ...
  toggleLiveReloadViaMenuItem: function (menuItem) {
    ...
    var focusedWindow = BrowserWindow.getFocusedWindow();
    focusedWindow.liveReloadEnabled = menuItem.checked;
    focusedWindow.send('toggle:livereload');
  }
};
...
app.on('ready', function handleReady () {
  ...
  // TODO: When our window is reloaded
    // If LiveReload is enabled in the window, then send a 'toggle:livereload' event
