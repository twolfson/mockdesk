...
var mockdesk = {
  ...
  toggleLiveReloadViaMenuItem: function (menuItem) {
    logger.debug('Toggling LiveReload in focused browser window');
    BrowserWindow.getFocusedWindow().send('toggle:livereload');

    // TODO: Inject a script tag now and on reload until we disable it
    // TODO: Apply to all windows OR update menu when jumping between windows
    // BrowserWindow.getFocusedWindow().toggleDevTools();
    // TODO: Update boolean correctly
...
app.on('ready', function handleReady () {
  ...
  mockdesk.browserWindow = new BrowserWindow(windowOpts);
  ...
  mockdesk.browserWindow.on('closed', function handleWindowClose () {
